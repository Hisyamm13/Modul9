...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="email" id="email" value="<?php echo e($errors->any() ? old('email') : $employee->email); ?>"
                                placeholder="Enter
        Email">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Modul9\resources\views/employee/edit.blade.php ENDPATH**/ ?>